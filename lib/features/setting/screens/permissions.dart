...
class PermissionHandlerWidget extends StatefulWidget {
  ...
  // static PermissionHandlerWidget createPage() {
  //   return ExamplePage(
  //     Icons.location_on,
...
class _PermissionState extends State<PermissionWidget> {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      title: Text(widget.permission.toString(), style: Theme.of(context).textTheme.bodyLarge),
      ...
      trailing: (widget.permission is PermissionWithService)
          ? IconButton(
              ...
              onPressed: () {
                checkServiceStatus(context, widget.permission as PermissionWithService);
              },
            )
          : null,
      onTap: () {
  ...
  void checkServiceStatus(BuildContext context, PermissionWithService permission) async {
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text((await permission.serviceStatus).toString())));
  }
